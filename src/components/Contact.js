    ...
    <div id="contact" className="bg-zinc-300 bg-auto bg-fixed bg-center bg-no-repeat flex md:w-screen">
      <div className="flex w-screen h-96 m-auto w-3/4 md:h-screen md:w-screen md:max-w-screen-2xl">
        <div className="m-auto md:w-2/5 text-center text-slate-800">
          ...
          <p className="mt-3 text-sm md:text-xl"> Interested in collaborating or have any questions? Feel free to send me an email or visit it me at any of the following the channels. I look forward to connecting! </p>
          ...
          <a href="mailto:parisaostovari@gmail.com"><button
            className="p-2 px-6 mt-10 border rounded-md text-md md:text-lg border-orange-800 text-orange-800 hover:border-cyan-800 hover:text-cyan-800 transition transform hover:scale-110 duration-700">
            Email </button>
          </a>
